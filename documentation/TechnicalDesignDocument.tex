...
\begin{document}
    ...
    A .jar file is exported from the editor application and included inside the view application.
    ...
    The editor library (.jar file) needs to validate if both m-blocks can be linked together.
